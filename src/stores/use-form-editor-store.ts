...
interface FormEditorStore {
  ...
  updateField: (sectionId: string, fieldId: string, field: Partial<FormField>) => void;
  removeField: (sectionId: string, fieldId: string) => void;
  reorderFields: (sectionId: string, activeId: string, overId: string) => void;
  reset: () => void;
}

export const useFormEditorStore = create<FormEditorStore>((set) => ({
  sections: [],
  ...
  updateField: (sectionId, fieldId, field) => set((state) => ({
    sections: state.sections.map((section) => {
      if (section.id === sectionId) {
        return {
          ...section,
